...
class PrimMSPTest {
    ...
    final void testFindMSP5() {
        ...
        assertThrows(NullPointerException.class, () -> alg.computeMSP(null, null));//eccezzione null
        assertThrows(NullPointerException.class, () -> alg.computeMSP(null, c));//eccezzione null
        assertThrows(NullPointerException.class, () -> alg.computeMSP(gr, null));//eccezzione null
        assertThrows(IllegalArgumentException.class, () -> alg.computeMSP(gr, new GraphNode<>("a")));//il nuovo nodo non esiste in gr
        ...
        gr1.addNode(h);
        gr1.addEdge(new GraphEdge<>(e, f, false, 1));
        assertThrows(IllegalArgumentException.class, () -> alg.computeMSP(gr1, e));//eccezzione il grafo è orientato
        gr.addEdge(new GraphEdge<>(g, h, false, -1));
        assertThrows(IllegalArgumentException.class, () -> alg.computeMSP(gr, g));//eccezzione un nodo ha peso negativo
    }
}